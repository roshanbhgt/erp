...
{/literal}
<form accept-charset="utf-8" method="post" action="{$FRONTEND}cashmemo.php">
<input type="hidden" name="id" value="{$order.id}" />
﻿<div class="dialog">
    <div class="interior">
        <div class="dialog-head">
            <a class="close-dialog" href="javascript:void(0)" style="display: none;">Close</a>
            <h3>Cash Memo Invoice {$order.chalan_no}</h3>
        </div>
                        ...
                        <option value="godown" {if $val.qty_type == 'godown'} selected="selected" {/if}>Godown</option>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 125px;text-align: center">
                                        <div id="data_item_shipping"></div>
                                        <input style="width:50px;" type="text" id="data_order_shipping" name="data[order][shipping]" value="{$order.shipping}" onchange="calculatetotal()" />
                                    </td>
                                </tr>
                                <tr>
            ...
            <div style="text-align: center;padding:25px 0;">
                ...
                <button class="button" type="submit" name="action" value="cashmemoinvoice" >Cash Memo Invoice</button>
                <button class="button" type="submit" name="action" value="cashmemoinvoiceprint" >Cash Memo Invoice And Print</button>
            </div>
    </div>
</div>
</form>
